		...
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
                    ...
                    $qry = $conn->query("SELECT DISTINCT sender_name, sender_address, sender_email FROM invoice $where");
					while($row= $qry->fetch_assoc()):
					?>
					<tr>
						<td class="text-center"><?php echo $i++ ?></td>
						<td class="text-center"><b><?php echo ucwords($row['sender_name']) ?></b></td>
						<td class="text-center"><b><?php echo ucwords($row['sender_address']) ?></b></td>
						<td class="text-center"><b><?php echo ucwords($row['sender_email']) ?></b></td>
					</tr>	
				<?php endwhile; ?>
				</tbody>
			</table>
