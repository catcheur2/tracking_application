	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary " href="./index.php?page=nouveau_conteneur"><i class="fa fa-plus"></i>Nouveau conteneur</a>
			</div>
		</div>
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					<?php
					$i = 1;
					$qry = $conn->query("SELECT * FROM conteneur ");
					...
					<tr>
						...
						<td class="text-center">
		                    <div class="btn-group">
								<a href="index.php?page=modifier_conteneur&id=<?php echo $row['id'] ?>" class="btn btn-primary btn-flat ">
		                          <i class="fas fa-edit"></i>
		                        </a>
		                        <button type="button" class="btn btn-danger btn-flat delete_conteneur" data-id="<?php echo $row['id'] ?>">
