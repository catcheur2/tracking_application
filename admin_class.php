...
Class Action {
	...
	function save_conteneur(){
		...
		if(empty($id)){
			$save = $this->db->query("INSERT INTO conteneur set $data");
		}else{
			$save = $this->db->query("UPDATE conteneur set $data where id = $id");
		}
		if($save){
			return 1;
		}
	...
	function save_destination(){
		...
		if(empty($id)){
			$save = $this->db->query("INSERT INTO destination set $data");
		}else{
			$save = $this->db->query("UPDATE destination set $data where id = $id");
		}
		if($save){
			return 1;
		}
	...
	function save_statut(){
		...
		if(empty($id)){
			$save = $this->db->query("INSERT INTO status_conteneur set $data");
		}else{
			$save = $this->db->query("UPDATE status_conteneur set $data where id = $id");
		}
		if($save){
			return 1;
		}
	...
	function delete_status(){
		extract($_POST);
		$delete = $this->db->query("DELETE FROM status_conteneur where id = $id");
		if($delete){
			return 1;
		}
	}

	function delete_conteneur(){
		extract($_POST);
		$delete = $this->db->query("DELETE FROM conteneur where id = $id");
		if($delete){
			return 1;
		}
	}
	...
	function delete_facture(){
		extract($_POST);
		$delete = $this->db->query("DELETE FROM invoice where sid = $id");
		if($delete){
			return 1;
		}
	}
	...
	function delete_destination(){
		extract($_POST);
		$delete = $this->db->query("DELETE FROM destination where id = $id");
		if($delete){
			return 1;
		}
	}
